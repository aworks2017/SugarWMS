...
class TimeDate
{
    ...
    {
		$nowTime = time();
		$week_start_date = strtotime("monday this week");
		$this_week = $nowTime - $week_start_date;
		$this_week_days = floor($this_week/(60*60*24));
		$this->date_expressions['this_week_range'] = array("-{$this_week_days} days", "");
